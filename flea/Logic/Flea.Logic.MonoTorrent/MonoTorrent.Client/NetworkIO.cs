...
namespace MonoTorrent.Client
{
    ...
    internal partial class NetworkIO
    {
        ...
        {
            AsyncConnectState data = connectCache.Dequeue().Initialise(connection, callback, state);

            try
            {
                IAsyncResult result = connection.BeginConnect(EndConnectCallback, data);
        ...
        {
            AsyncIOState data = transferCache.Dequeue()
        ...
        {
            AsyncConnectState data = (AsyncConnectState) result.AsyncState;
            try
            {
        ...
        {
            AsyncIOState data = (AsyncIOState) result.AsyncState;
            try
            {
